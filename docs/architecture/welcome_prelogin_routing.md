...
- **`/welcome`**: одна длинная страница со скроллом: в hero сверху **MomRecipes 🌿**, затем заголовок «Спокойствие за питание ребёнка — каждый день», подзаголовки про меню без лишних раздумий и «Меню, рецепты и советы — за пару минут»; далее CTA «Войти» и блоки контента; три карточки преимуществ; блок «Как выглядит рецепт в приложении»; основные CTA на регистрацию — **«Получить свой план»** (два места: после карточек и в финальном блоке).
