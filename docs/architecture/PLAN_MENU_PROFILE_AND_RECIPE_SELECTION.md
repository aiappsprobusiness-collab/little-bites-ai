...
**Намеренно расходится:** **slot-fit** — на Edge полный скоринг слота (цели, cultural, variety, base…), на клиенте только **lite**-прокси. Поэтому 100% совпадение победителя не гарантируется, но при близком порядке по slot-fit совпадения существенно чаще.
