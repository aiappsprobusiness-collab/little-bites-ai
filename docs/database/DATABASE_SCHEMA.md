...
| nutrition_goals     | jsonb NOT NULL DEFAULT '[]' | Goals для UI/плана: balanced, iron_support, brain_development, weight_gain, gentle_digestion, energy_boost (CHECK whitelist) |
