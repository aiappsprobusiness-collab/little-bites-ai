-- =============================================================================
-- Dashboard: Retention D1 / D7 / D30 — сводка (одна строка)
-- =============================================================================
-- Логика совпадает с первым SELECT в retention_d1_d7_d30.sql (без сегментов).
-- Параметры: cohort_from, cohort_to (UTC date), data_through (UTC date)
-- =============================================================================
