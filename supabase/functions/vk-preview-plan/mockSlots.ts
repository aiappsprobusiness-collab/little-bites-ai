...
const MOCK_CANDIDATES: Record<MealSlot, MockCandidate[]> = {
  breakfast: [
    ...
    {
      title: "Тёплый нежный завтрак",
      description: "Баланс энергии на утро.",
      calories: 210,
      protein: 7,
      fat: 5,
      carbs: 32,
  ...
  lunch: [
    ...
    {
      title: "Лёгкий согревающий обед",
      description: "Домашнее горячее на середину дня.",
      calories: 220,
      protein: 14,
      fat: 8,
      carbs: 22,
    ...
    {
      title: "Обед домашний",
      description: "Сытно и по-домашнему.",
      calories: 240,
      protein: 16,
      fat: 9,
      carbs: 24,
  ...
  dinner: [
    ...
    {
      title: "Нежное блюдо на вечер",
      description: "Сытно и без лишней тяжести.",
      calories: 250,
      protein: 18,
      fat: 10,
      carbs: 20,
  ...
  snack: [
    ...
    {
      title: "Перекус со вкусом",
      description: "Небольшая порция для тонуса.",
      calories: 120,
      protein: 4,
      fat: 5,
      carbs: 14,
