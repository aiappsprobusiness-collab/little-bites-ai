...
const MSG_REPEAT_AFTER_MENU_EXAMPLE = [
  "Я уже показала тебе пример меню на день 👆",
  "",
  "В приложении мы продолжим спокойнее:",
  "• новые блюда под твоего ребёнка,",
  "• с учётом того, что он не ест,",
  "• и поддержка в повседневном питании — даже когда отказывается или капризничает 💛",
  "",
  "👇 Загляни в приложение — там всё для этого собрано.",
].join("\n");
