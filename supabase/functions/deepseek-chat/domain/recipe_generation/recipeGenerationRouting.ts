...
export const UNDER_12_CURATED_RECIPE_BLOCK_MESSAGE = [
  "Для малышей до года мы не генерируем рецепты автоматически, чтобы рекомендации были максимально аккуратными и проверенными.",
  "Вы можете выбрать подходящие блюда в плане питания или посмотреть рекомендации по введению продуктов в разделе «Помощь маме».",
].join("\n\n");
