...
Поля: title, description (1–2 предложения, макс. 160 симв.), ingredients [{name, amount}] до 10, steps 5–7 (до 150 симв. каждая), cookingTime, mealType, servings, chefAdvice (макс. 260 симв., 2–3 предложения), nutrition (kcal_per_serving, protein/fat/carbs, is_estimate: true).
