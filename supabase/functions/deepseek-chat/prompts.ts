...
ИНГРЕДИЕНТЫ: amount — строка с количеством (e.g. "150 g", "1 tbsp"). ШАГИ: максимум 7 коротких шагов.
Обязательно заполни поле advice (мини-совет, 1–3 предложения): короткий практический совет по приготовлению или подаче для мамы.
`;
