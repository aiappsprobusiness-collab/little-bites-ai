...
chefAdvice — совет шефа: 2–3 предложения, конкретная техника для этого рецепта (текстура, аромат, температура, порядок добавления, подача). Звучать как живой совет. Точка только в конце предложения: не ставить точку перед глаголом в середине фразы (например «и сразу перемешайте», а не «и сразу. перемешайте»). Запрещено: «Для максимальной…», «Для более…», «Для получения…», «Чтобы блюдо получилось…», «Вы можете…», «Если хотите…», «Это блюдо», «Данное блюдо». Не писать универсальный текст под любой рецепт.
...
Запрещено упоминать профиль, возраст, детей/семью, аллергии и dislikes в description, steps и chefAdvice.
При конфликте — замена ингредиента, всё равно верни рецепт. Возраст <12 мес: без соли, сахара, мёда, цельного молока. 12–35 мес: без жарки/острого. Ингредиенты: у каждого amount с единицей (г, мл, шт., ст.л., ч.л.).
`;
