...
export const ALLERGY_ALIASES: AllergyAlias[] = [
  ...
  },
  {
    ...
    tokens: ["глютен", "пшениц", "рож", "рожь", "ржан", "ячмен", "овес", "овсян", "мук", "манк", "булгур", "кускус", "макарон", "паста", "лазань", "хлеб", "выпечк", "gluten", "wheat", "rye", "barley", "oats"],
  },
  {
    canonical: "яйца",
    display: "яйца",
