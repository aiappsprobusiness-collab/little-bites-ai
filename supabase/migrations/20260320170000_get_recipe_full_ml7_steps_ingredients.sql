-- ML-7: get_recipe_full возвращает локализованные steps_json и ingredients_json при p_locale.
-- Fallback на базовые recipe_steps.instruction и recipe_ingredients.name/display_text при отсутствии перевода.
...
COMMENT ON FUNCTION public.get_recipe_full(uuid, text) IS
  'Full recipe for detail screen. p_locale: title/description/chef_advice from recipe_translations; steps_json and ingredients_json localized via recipe_step_translations and recipe_ingredient_translations with fallback to base tables.';
