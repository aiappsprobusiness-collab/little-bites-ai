-- Soft paywall «Замена блюда» + онбординг trial: новые feature в analytics.usage_events_enriched.
...
COMMENT ON VIEW analytics.usage_events_enriched IS
  'Обогащённые usage_events: event_group, event_type, jsonb properties как плоские поля. Replace meal soft paywall + trial onboarding.';
