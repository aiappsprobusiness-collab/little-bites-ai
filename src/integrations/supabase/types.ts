/** DEPRECATED: Use types-v2.ts for members and profiles. Legacy: autogenerated DB types (children, user_usage, etc.). */
export type Json =
  | string
  | number
  | boolean
...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      get_recipe_by_share_ref: { Args: { p_share_ref: string; p_locale?: string | null }; Returns: unknown }
      get_public_catalog_recipe_by_id: { Args: { p_recipe_id: string; p_locale?: string | null }; Returns: unknown }
      has_role: {
        Args: {
