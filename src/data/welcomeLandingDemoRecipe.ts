...
export const WELCOME_LANDING_DEMO_RECIPE: PublicRecipePayload = {
  ...
  description:
    "Нежные котлеты с добавлением кабачка сохраняют сочность и легко усваиваются. Блюдо богато белком и клетчаткой для сытного ужина.",
  meal_type: "dinner",
  ...
  chef_advice: "Отжатый сок от кабачка можно добавить в фарш для большей сочности, если консистенция позволяет.",
  advice: null,
};
